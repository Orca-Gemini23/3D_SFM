...
output_folder = r'C:\Users\csyas\OneDrive\Desktop\projects\3D_SFM\3_SFM'
...
def estimate_camera_poses(images_folder):
    ...
    # Assume the first camera has an identity pose
    camera_poses = [{'rotation': np.eye(3), 'translation': np.zeros((3, 1))}]
